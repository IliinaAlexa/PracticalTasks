...
namespace TransportPark
{
    ...
    class Program
    {
...

        {
            ...
            Chassis chassis = new Chassis(4, 1500, 7896); // class object chassis for car
            Engine engine = new Engine(150, 2, "diesle", 1234); // class object engine for car
            ...
            Engine engineScooter = new Engine(70, 1, "diesle", 58789); // class object engine for scooter
            Transmission transmissionScooter = new Transmission("manual", 4, "HGUS"); // class object transmission for scooter
            Chassis chassisCarKIA = new Chassis(6, 2000, 5842);
            ...
            Engine engineBusMAN = new Engine(300, 3, "diesele", 74588);
            Transmission transmissionBusMAN = new Transmission("manual", 6, "HRT");
            Chassis chassisTruckGAZ = new Chassis(12, 7000, 98561);
            Engine engineTruckGAZ = new Engine(300, 1.5, "diesele", 7635);
            Transmission transmissionTruckGAZ = new Transmission("manual", 6, "YTHF");
            Chassis chassisScooterBMW = new Chassis(6, 600, 58595);
            Engine engineScooterBMW = new Engine(80, 1, "petrole", 58789);
            ...
            Console.WriteLine(transportPark.ToString());
